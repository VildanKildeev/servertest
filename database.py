...
work_requests = sqlalchemy.Table(
    ...
    # НОВЫЙ СТОЛБЕЦ: Исполнитель заявки
...
# НОВАЯ ТАБЛИЦА: для сообщений чата
...
machinery_requests = sqlalchemy.Table(
    ...
    sqlalchemy.Column("min_rental_hours", sqlalchemy.Integer, nullable=True),
